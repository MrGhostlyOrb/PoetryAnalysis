...
for algo in algorithms:
    algos[algo] = list()
for root, dirs, files in os.walk("../generated/petrarchan_sonnets"):
    for file in files:
        if file.endswith(".man") or file.endswith(".soundex") or file.endswith(".metaphone") or file.endswith(".doublemetaphone") or file.endswith(".daitchmokotoffsoundex"):
            pass
        else:
