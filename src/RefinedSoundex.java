...
public class RefinedSoundex {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(RefinedSoundex.getRhymeScheme(poem));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
    }

    public static String getRhymeScheme(Poem poem) throws FileNotFoundException, FileNotFoundException {
        ...
        for (String line : poem.getLines()) {
            ...
            org.apache.commons.codec.language.RefinedSoundex soundex = new org.apache.commons.codec.language.RefinedSoundex();
